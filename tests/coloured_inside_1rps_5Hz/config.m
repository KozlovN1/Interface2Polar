...
%% %Parameters%
epsilonn = 2.75; % ratio between colour channels or conrast criterion for monochrome signal
    ROI = [508, 508, 2780, 2780]; % [x1, y1, x2, y2] (pix)
 center = [1653, 1650]; % [xc, yc] (pix)
     R2 = 1122; % Radius of the studied domain (e.g. of a container or cell) (pix)
windoww = 24; % argument passed to local_average (number of elements)
